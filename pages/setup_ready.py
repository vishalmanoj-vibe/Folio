                ...
                [
                    ...
                    html.Div(
                        [
                            ...
                            html.Div([html.Span("✓", className="setup-step-num"), "AI Analyst"], className="setup-step completed"),
                            html.Div([html.Span("3", className="setup-step-num"), "Ready"], className="setup-step active"),
                        ],
