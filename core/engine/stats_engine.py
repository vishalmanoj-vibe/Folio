...
def build_live_table_rows(
    holdings: list[dict], sort_col: str = "ticker", sort_dir: str = "asc"
) -> list[dict]:
    """
    ...
    sorted_holdings = sorted(holdings, key=get_sort_val, reverse=(sort_dir == "desc"))
