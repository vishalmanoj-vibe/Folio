...
# Inject CSS for dark mode and print
app.index_string = '''
<!DOCTYPE html>
<html>
...
.Select .Select-menu-outer { background: var(--surface) !important; border: 1px solid var(--border) !important; }
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Button("⬇ Download PDF", id="pdf-btn", n_clicks=0,
                    style={"fontWeight":"500", "alignSelf":"flex-end"}),
...
app.clientside_callback(
    ...
    Output("pdf-btn", "children"),   # dummy output
